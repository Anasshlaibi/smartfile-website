...
<section id="hero" class="relative w-full min-h-screen h-screen overflow-hidden bg-[#2D2658] flex items-center">
    
    <!-- 0ms: Full-Bleed Cinematic Background Video & High-Resolution Fallback Poster (Framing Unchanged) -->
    <div class="absolute inset-0 w-full h-full pointer-events-none">
        ...
        <div class="absolute inset-0 bg-gradient-to-t from-[#2D2658]/95 via-[#2D2658]/40 to-transparent"></div>
        <div class="absolute inset-0 bg-gradient-to-r from-[#2D2658]/90 via-[#2D2658]/50 to-transparent"></div>
        <div class="absolute top-0 left-0 right-0 h-44 bg-gradient-to-b from-black/60 to-transparent"></div>
    </div>

    <!-- Live Audio Toggle Control (Top Right) -->
    <button onclick="toggleHeroAudio()" id="audioToggleBtn" class="absolute top-24 right-6 sm:top-28 sm:right-10 z-20 glass-dark text-white/90 hover:text-white px-4 py-2 rounded-full text-xs font-medium tracking-wider flex items-center gap-2.5 transition-all duration-300 hover:border-[#FF5A68] shadow-2xl hover:scale-105">
    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-12 pt-20 sm:pt-24 pb-12 flex flex-col justify-center">
        <div class="w-full max-w-3xl lg:max-w-[70%] text-white space-y-5 sm:space-y-6">
            ...
            <div>
                <div class="hero-eyebrow inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-black/40 backdrop-blur-md border border-white/15 text-[10px] sm:text-[11px] font-mono tracking-widest uppercase font-semibold text-white/95 shadow-lg">
            ...
            <div class="space-y-1">
                ...
                <div class="reveal-mask pr-4">
                    <span class="hero-serif font-serif-italic font-normal block lowercase text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-[#FADDE3] drop-shadow-2xl">
                        agence de
                    </span>
                </div>
            ...
            <div class="reveal-mask pt-1 sm:pt-2">
                <p class="hero-desc text-[#ECE9F3] text-sm sm:text-base md:text-lg font-light max-w-xl leading-relaxed">
            ...
            <div class="pt-2 sm:pt-3">
                <a href="#estimateur" class="hero-cta inline-flex items-center gap-3 bg-[#FF5A68] hover:bg-[#E84554] text-white px-8 py-4 rounded-full font-bold uppercase tracking-wider text-xs transition-all duration-300 shadow-[0_0_35px_rgba(255,90,104,0.5)] hover:shadow-[0_0_50px_rgba(255,90,104,0.75)] hover:scale-105 group">
